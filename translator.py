...
root = tk.Tk()
root.title('Language Translator By Vishal Martha')
root.geometry('590x370')


frame1=Frame(root, width=590, height=370, relief=RIDGE, borderwidth=5, bg='#B4BDFF')
frame1.place(x=0, y=0)
Label(root, text="Language Translator", font=("Helvetica 17 bold"), fg="black", bg='#B4BDFF' ).pack(pady=4)
Label(root, text="Project Design By Vishal Martha", font=("Helvetica 9 bold"), fg="black", bg='#B4BDFF').pack(pady=0)
...
choose_language['value'] =( #add all LAnguage
                           'Hindi',
                           'English',
...
btn1 =Button(frame1, command=translate,text="Translate", relief=RAISED, borderwidth=2, font=('verdana', 10, 'bold'),bg='#F05941', fg="white", cursor="hand2")
btn1.place(x=185, y=300)

btn2 =Button(frame1, command=clear, text="Clear", relief=RAISED, borderwidth=2, font=('verdana', 10, 'bold'),bg='#F05941', fg="white", cursor="hand2")
